...
class Carlaeni(Env):
    ...
    def step(self, action):
        ...
        accel = self.data_dict['imu']['accel'] - \
            carla.Vector3D(x=0, y=0, z=9.81)
        ...
        # observation, reward, status, extra information
    ...
    def reset(self):
        ...
        collision_sensor = self.blueprint_library.find(
            "sensor.other.collision")
        self.collision_sensor = self.world.spawn_actor(
            collision_sensor, transform, attach_to=self.vehicle)
        ...
        self.imu_sensor = self.world.spawn_actor(
            imu_sensor, transform_s, attach_to=self.vehicle)
